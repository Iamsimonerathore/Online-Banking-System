...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(String pin){
        ...
        l1.setBounds(149,250,400,20);
        l3.add(l1);
        
        l2.setBounds(162,290,400,20);
        l3.add(l2);
        
        t1.setBounds(145,330,300,30);
        l3.add(t1);
        
        b1.setBounds(300,420,150,25);
        l3.add(b1);
        
        b2.setBounds(300,450,150,25);
        l3.add(b2);
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    int balance = 0;
                    while(rs.next()){
                       if(rs.getString("pin").equals("Deposit")){
